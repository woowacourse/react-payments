import { CARD_NUMBER, CARD_OWNER, CARD_PERIOD, CARD_PROVIDER, PERIOD } from '../constants/inputInformation';
...
export type InformationDetailType = 'number' | 'owner' | 'month' | 'year' | 'provider';
