...
function useCardValidationError({
  ...
  const validateCardNumber = (cardNumber: string[]) =>
    dispatch({ type: 'VALIDATE_CARD_NUMBER', payload: { cardNumber } });
  ...
  const validatePeriod = (year: string, month: string, type: ExpiryField) => {
    dispatch({
  ...
  const validatePassword = (cardPassword: string) => {
    dispatch({
...
export default useCardValidationError;
