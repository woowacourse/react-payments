...
const CardAddForm = props => (
  <form className="relative w-full h-160 flex flex-col justify-center">
    <div>
      ...
      <div className="flex flex-col w-full mb-2">
        ...
        <Input id="card-number-input" type="text" className="w-full" minLength="18" maxLength="19" required />
      </div>
      <div className="flex flex-col w-full mb-2">
        <div className="mb-2 h-6">
      ...
      <div className="flex flex-col w-full mb-2">
        <div className="mb-2 h-6 flex justify-between items-center">
          ...
          <span className="text-custom-gray-300 font-medium text-xs">0/30</span>
        </div>
      ...
      <div className="flex flex-col w-full mb-2">
        ...
        <div className="flex items-center">
          <Input type="password" className="w-20" minLength="3" maxLength="4" required />
          <svg
            width="27"
            height="27"
      ...
      <div className="flex flex-col w-full">
        ...
        <div className="flex items-center justify-between w-48">
          ...
          <Input type="password" className="w-10" minLength="1" maxLength="1" />
