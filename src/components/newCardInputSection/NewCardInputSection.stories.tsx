...
export const CardNumbers: Story = {
  args: {
    ...
    children: Array.from({ length: 4 }).map((_, index) => (
      <Input key={index} maxLength={4} placeholder='1234' />
    )),
  },
};
...
export const CardExpiration: Story = {
  args: {
    ...
    children: [
      <Input key='month' maxLength={2} placeholder='MM' />,
      <Input key='year' maxLength={2} placeholder='YY' />,
    ],
  },
};
