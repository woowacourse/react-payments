...
import { ExpiredInput } from 'types/SomeInput';
import { MutableRefObject, ChangeEvent } from 'react';

interface ExpiredDateInputProps {
  expiredDate: ExpiredInput<string>;
  validations: ExpiredInput<boolean>;
  inputRefs: ExpiredInput<MutableRefObject<HTMLInputElement | null>>;
