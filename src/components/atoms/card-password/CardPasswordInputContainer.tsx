...
const CardPasswordInputContainer = forwardRef<HTMLInputElement, Props>(
  ({ position, disabled }, ref) => {
    ...
    const val = password[position]
      ? transformNumToBullet(password[position])
      : "";
    return (
      <CardPasswordInput
