import { BACKSPASE_KEY, CARD_NUMBER_ERASE_SYMBOL, ERASE_UNTIL_CARD_NUMBER, EXPIRED_DATE_ERASE_SYMBOL, EXPIRED_DATE_PLUS_SYMBOL, INPUT_MAX_LENGTH, SEPERATED_CARD_NUMBER_LENGTH } from "../constants";
