...
export const FailedWithInvalidNumberStory: Story = {
  args: {},
  decorators: [
    (Story) => {
      return (
  ...
  play: async ({ canvasElement }) => {
    ...
    await userEvent.type(cardNumber0, '527212341234123', { delay: 100 });
    expect(cardNumber0).toHaveValue('5272');
    expect(cardNumber1).toHaveValue('1234');
...
export const FailedWithInvalidSecurityCodeStory: Story = {
  args: {},
  decorators: [
    (Story) => {
      return (
  ...
  play: async ({ canvasElement }) => {
    ...
    const securityCodeInput = document.querySelector('input[id="security-code"]')!;
    await userEvent.type(securityCodeInput, '45', { delay: 100 });
...
export const FailedWithInvalidPasswordStory: Story = {
  args: {},
  decorators: [
    (Story) => {
      return (
  ...
  play: async ({ canvasElement }) => {
    ...
    const securityCodeInput = document.querySelector('input[id="security-code"]')!;
    await userEvent.type(securityCodeInput, '456', { delay: 100 });

    const passwordInput = document.querySelector('input[id="first-password"]')!;
    await userEvent.type(passwordInput, '1e', { delay: 100 });
