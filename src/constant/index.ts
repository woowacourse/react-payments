...
type DATE_INPUT_PLACEHOLDER_TYPE = {
  [key: string]: string;
};

export const DATE_INPUT_PLACEHOLDER: DATE_INPUT_PLACEHOLDER_TYPE = { month: 'MM', year: 'YY' };

type PLACEHOLDER_TYPE = {
  [key: string]: string;
};

export const PLACEHOLDER: PLACEHOLDER_TYPE = {
  NAME: 'NAME',
