...
import { CARD_NUMBER_UNIT_LENGTH } from './constants/input';
      ...
      <section className={styles.layout}>
        ...
        <Form>
          <div className={styles.shelf__section}>
            ...
            <CardNumbersInputField cardNumbers={cardNumbers} setCardNumbers={setCardNumbers} />
          </div>
          ...
          <div className={styles.shelf__section}>
            ...
            <CardOwnerNameInputField ownerName={ownerName} setOwnerName={setOwnerName} />
          </div>
        </Form>
      </section>
    </main>
