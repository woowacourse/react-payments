<details>
<summary>STEP1 요구사항 정리 (록바💪🏽 X 무비🎬)</summary>
...
- [x] 카드 추가 확인
  - [x] 추가하고 싶은 카드의 모든 정보를 올바르게 입력하면, 카드가 등록된다.
  - [x] 카드 등록이 완료되면 카드의 별칭을 입력할 수 있다.
  - [x] 별칭이 입력되면 보유카드 목록에 카드가 추가된다.
- [x] 카드 목록
  - [x] 현재까지 등록된 모든 카드를 확인할 수 있고, 새로운 카드를 추가할 수 있다.
  - [x] 카드의 미리보기 이미지와, 카드의 별칭이 보여진다.
